[« Previous](./Task_Design_and_Scheduling.md) | [Index](./README.md) | [Next »](<./Inter-Task_Communication_(IPC).md>)
...
- **One-to-one signaling (no payload):**
  ...
  _Zero allocation, fastest path. Consider `xTaskNotifyIndexed` if using multiple channels._
...
- **Mutual exclusion for shared resource (driver/state):**
  ...
  _Binary semaphore is **not** a mutex._
